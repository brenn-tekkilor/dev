...
@Component({
  selector: 'storeReceiptSerialDataComponent',
  templateUrl: 'store-receipt-serial-data-component.html',
  styleUrls: ['store-receipt-serial-data-component.css']
})
export class StoreReceiptSerialDataComponent implements OnInit, OnDestroy {
  ...
  onChanges( event: any): void {
      ...
      if (name === 'store') {
        ...
        for (const r of this.targetStore.registers) {
          if (r.departmentCode <= 1) {
            registers.push(r);
          }
        }
